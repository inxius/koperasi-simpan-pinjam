  ...
  <body>
    <div id="wrapper">
      <div id="page-wrapper">
          <div class="row">
            <div class="col-lg-12">
              <h1 class="page-header">Transaksi Simpan</h1>
            </div>
          </div>
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-md-4 col-sm-4 col-md-offset-4 col-sm-offset-4">
                <?php echo form_open('Petugas/aksi_simpan'); ?>
                <?php foreach ($data_anggota as $anggota) { ?>
                  ...
                  <div class="form-group">
                    <label class="checkbox-inline">
                      <input type="checkbox" class="" name="simp_wajib" value="1">Simpanan Wajib
                    </label>
                    <br><br>
                    <label>Simpanan Sukarela</label>
                    <div class="form-group input-group">
                      <span class="input-group-addon">Rp</span>
                      <input type="text" pattern="[0-9]+" class="form-control" name="simp_suka" value="" placeholder="Nilai Simpanan Sukarela">
                    </div>
                  </div>
