	...
	<div id="wrapper">
		<div id="page-wrapper">
			<div class="row">
				...
				<!-- /.col-lg-12 -->
			<div class="row">
				<?php echo form_open('sinduadi/search/transaksi'); ?>
					<div class="col-lg-4">
					...
					<?php echo form_close(); ?>
					<div class="col-lg-1">
						<?php echo form_open('Petugas/vw_transaksi_umum'); ?>
						<div class="text-left">
							<br>
						...
						<tbody>
							...
							<?php foreach ($dt_anggota as $anggota) { ?>
								<tr>
									...
									<td>
										<a href="<?php echo base_url().'Petugas/trans_simpan/'.$anggota->nokta; ?>">
											<button type="button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus" aria-hidden="true"></button>
										</a>
										<a href="<?php echo base_url().'Petugas/trans_ambil/'.$anggota->nokta; ?>">
											<button type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-minus" aria-hidden="true"></button>
										</a>
									</td>
								</tr>
							<?php $iterasi++; } ?>
