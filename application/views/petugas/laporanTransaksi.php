		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-8 col-sm-8">
					<h1 class="page-header">Laporan Transaksi Anggota</h1>
				</div>
				...
				<!-- /.col-lg-12 -->
			<div class="row">
				<?php echo form_open('sinduadi/search/anggota'); ?>
					<div class="col-lg-4">
							...
							<?php foreach ($dt_anggota as $anggota) { ?>
								<tr>
									...
									<td class="text-center">
										<a href="<?php echo base_url().'Petugas/rincianAnggota/'.$anggota->nokta.'/1'; ?>">
											<button type="button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></button>
										</a>
									</td>
								</tr>
							<?php $iterasi++; } ?>
