		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-8 col-sm-8">
					<h2 class="page-header">Transaksi Pengajuan Pinjaman</h2>
				</div>
			...
			<div class="row">
				<?php echo form_open('sinduadi/search_transaksi'); ?>
					...
					<?php echo form_close(); ?>
					<div class="col-lg-1">
						<?php echo form_open('sinduadi/vw_anggota'); ?>
						<div class="text-left">
							<br>
						...
						<tbody>
							...
							<?php foreach ($dt_anggota as $anggota) { ?>
								<tr>
									...
									<td><?php echo $anggota->nominal; ?></td>
									<td class="text-center">
										<a href="<?php echo base_url().'index.php/Pengurus/trans_verifikasi_pinjam/'.$anggota->nokta; ?>">
